...
func (t *TreeNode[T]) IncludesRecursiveDFS(searching T) bool {
	if t == nil {
		return false
	}
	...
	return t.Left.IncludesRecursiveDFS(searching) || t.Right.IncludesRecursiveDFS(searching)
}

func (t *TreeNode[T]) IncludesIterativeDFS(searching T) bool {
	if t == nil {
		return false
	}
...
func (t *TreeNode[T]) IncludesBFS(searching T) bool {
	if t == nil {
		return false
	}
